<section id="frontpage-testimonials" class="fp-section mt-5">
	<h1 class="text-center fp-section-header">Words from our Clients</h1>
	<div id="fp-testimonials-layout">
		<!-- Testimonial 1 -->
		<div 
			class="fp-testimonial testimonial-1 text-center"
			data-aos="fade-in" 
			data-aos-delay="200"
		...
		>
			<?php
				...
				$testimonialImg = attachment_url_to_postid( $url1."/wp-content/uploads/2018/10/testimonial-frame-corner.png" );
				for($i=1; $i<5; $i++) {
					echo '<div class="testimonial-image-box corner-'.$i.'">';
		...
		>
			<?php
				...
				?>
			<div class="quote-text" style="font-size: 16px;">
				<p>&quot;Work that paint. We'll lay all these little funky little things in there. Imagination is the key to painting. Decide where your cloud lives. Maybe he lives right in here. We tell people sometimes: we're like drug dealers, come into town and get everybody absolutely addicted to painting. It doesn't take much to get you addicted.&quot;</p>
